    ...
    <div className="flex justify-center mb-6">
        ...
        {!image ? (
            ...
            <div className="relative">
                <img src={preview || previewUrl} alt="profile_pic" 
                    className='w-20 h-20 rounded-full object-cover'
                />
                <button className="w-8 h-8 flex items-center cursor-pointer justify-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-1 " type='button' onClick={handleRemoveImage}>
                    <LuTrash />
                </button>
            </div>
        )}
